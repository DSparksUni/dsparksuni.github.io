...
export class Life {
     ...
     */
    cols() {
        const ret = wasm.life_cols(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} row
     ...
     */
    rows() {
        const ret = wasm.life_rows(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} row
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('life_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
